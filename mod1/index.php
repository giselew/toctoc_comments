...
$LANG->includeLLFile('EXT:toctoc_comments/mod1/locallang.xml');
                ...
                <tr>
                  ...
                  if ($row[$approvedField])	{
                    $content .='
                      ...
                      <img src="'.$GLOBALS['BACK_PATH'].'../typo3conf/ext/toctoc_comments/icon_tx_toctoc_comments.gif" border="0" title="'.$LANG->getLL('disapprove').'" align="top" alt=""
                      /></a></td>
                    ';
                  }
                    ...
                    $content .= '
                      ...
                      <img src="'.$GLOBALS['BACK_PATH'].'../typo3conf/ext/toctoc_comments/icon_tx_toctoc_comments_not_approved.gif" border="0" title="'.$LANG->getLL('approve').'" align="top" alt="" /></a></td>';
                  }
