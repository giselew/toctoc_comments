 ...
 * 1333:     public function pvs_fetch_images($strextraction,&$strouthtml, $iscss, $cssfile='')
 * 1487:     protected function pvs_fetch_css($strextraction,&$strouthtml, $iscss, $cssfile='')
 * 1591:     protected function checklogopattern($strtest)
 * 1617:     protected function checkimagepattern($strtest)
 * 1643:     protected function checkvideocontent($html)
 * 1924:     protected function croptitleordesc($description)
 * 1947:     protected function cleanouttitleordesc($title)
 *
 * TOTAL FUNCTIONS: 13
	...
	public function previewsite ($pObj=null, $pObjParent=null) {
		...
		if ($html) {
			...
			if ($this->conf['attachments.']['useWebpageVideoPreview'] == 1) {
				if ($this->checkvideocontent($html) != '') {
