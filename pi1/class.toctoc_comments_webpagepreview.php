 ...
 * 1286:     public function pvs_fetch_images($strextraction,&$strouthtml, $iscss, $cssfile='')
 * 1440:     protected function pvs_fetch_css($strextraction,&$strouthtml, $iscss, $cssfile='')
 * 1542:     protected function checklogopattern($strtest)
 * 1568:     protected function checkimagepattern($strtest)
 *
 * TOTAL FUNCTIONS: 10
