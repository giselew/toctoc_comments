 ...
 *  506:     public function saveAndResize($filename, $new_width, $new_height, $pathAndFilename, $ext)
 *  816:     public function previewsite ($pObj=null, $pObjParent=null)
 * 1297:     public function pvs_fetch_images($strextraction,&$strouthtml, $iscss, $cssfile='')
 * 1451:     protected function pvs_fetch_css($strextraction,&$strouthtml, $iscss, $cssfile='')
 * 1555:     protected function checklogopattern($strtest)
 * 1581:     protected function checkimagepattern($strtest)
 *
 * TOTAL FUNCTIONS: 10
