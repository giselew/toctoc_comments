 ...
 *  424:     protected function create_thumbnail_frompdf($pdffile,$pdffilejpg, $impath)
 *
 * TOTAL FUNCTIONS: 2
...
class toctoc_comments_attachmentupload {
	...
	// Logo won't be resized'
		...
		if ($files['myfile']['type'] =='application/pdf') {
			...
			if ($pdffilejpg==''){
				$pathirname=$post['toctoc_comments_pi1']['configbaseURL'] . 'typo3conf/ext/toctoc_comments/res/css/themes/' . $post['toctoc_comments_pi1']['theme'] . '/img/';
