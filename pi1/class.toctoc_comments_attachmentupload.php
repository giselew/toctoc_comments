 ...
 *  425:     protected function create_thumbnail_frompdf($pdffile,$pdffilejpg, $impath)
 *
 * TOTAL FUNCTIONS: 2
...
class toctoc_comments_attachmentupload {
	...
	public function main($files,$post) {
		...
		//print '@@@/typo3conf/ext/toctoc_comments/res/css/themes/' . $post['toctoc_comments_pi1']['theme'] . '/img/@@@';
	...
	// Logo won't be resized'
		...
		if ($files['myfile']['type'] =='application/pdf') {
			...
			if ($pdffilejpg==''){
				$pathirname='/typo3conf/ext/toctoc_comments/res/css/themes/' . $post['toctoc_comments_pi1']['theme'] . '/img/';
