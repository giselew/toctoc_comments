 ...
 *
 *
 *   72: class tx_toctoccomments_pi1 extends tslib_pibase
 *  116:     public function main($content, $conf, $hookTablePrefix = '', $hookId = 0, $hookcObj = null)
 *  732:     protected function checkJSLoc()
 *  774:     protected function checkCSSTheme()
 *  862:     protected function checkCSSLoc()
 *  925:     protected function initprefixToTableMap()
 *  957:     function init()
 * 1060:     function mergeConfiguration()
 * 1213:     function fetchConfigValue($param)
 * 1236:     function createLinks($text)
 * 1255:     function applyStdWrap($text, $stdWrapName)
 *
 * TOTAL FUNCTIONS: 10
 ...
 */
		...
		if (!isset($conf['advanced.'])) {
			...
			return $this->pi_wrapInBaseClass($this->lib->pi_getLLWrap($this, 'error', false) . ': ' . $this->lib->pi_getLLWrap($this, 'error.no.ts.template', false));
		}
