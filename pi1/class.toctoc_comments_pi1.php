 ...
 *
 *
 *   82: class tx_toctoccomments_pi1 extends tslib_pibase
 *  145:     public function main($content, $conf, $hookTablePrefix = '', $hookId = 0, $hookcObj = null)
 * 1550:     protected function checkJSLoc()
 * 1637:     protected function checkCSSTheme()
 * 1728:     protected function checkCSSLoc()
 * 1826:     protected function initprefixToTableMap()
 * 1858:     function init($newconfigcsswaswritten = 0)
 * 2269:     function mergeConfiguration()
 * 2478:     function fetchConfigValue($param)
 * 2501:     function createLinks($text)
 * 2520:     function applyStdWrap($text, $stdWrapName)
 * 2532:     protected function ae_detect_ie()
 * 2553:     protected function boxmodel($newconfigcsswaswritten = 0)
 * 2866:     protected function calculate_string( $mathString )
 * 2887:     protected function locationHeaderUrlsubDir()
 * 2903:     protected function currentPageName()
 * 2923:     protected function ttclearcache ($pid, $withplugin=true, $withcache = false, $debugstr = '')
 * 2948:     protected function doClearCache ($forceclear=false)
 * 2974:     protected function getPluginCacheControlTstamp ($external_ref_uid)
 * 2995:     protected function initLegacyCache ()
 * 3007:     protected function check_scopes()
 *
 * TOTAL FUNCTIONS: 20
 ...
 */
	...
	protected function checkCSSTheme() {
			...
			$filenamecssfile='tx-tc40-theme.css';
...
.tx-tc-pi1 .tx-tc-cts-form-fieldtextarea-1 {
	...
	protected function boxmodel($newconfigcsswaswritten = 0) {
		...
		$filenamecssfile='tx-tc40.css';
		if (trim($this->conf['theme.']['selectedBoxmodel']) != '') {
			$filenamecssoutfile='tx-tc40-' . str_replace('.txt','',$this->conf['theme.']['selectedBoxmodel']) .'.css';
		} else {
			$filenamecssoutfile='tx-tc40-system.css';
		}
