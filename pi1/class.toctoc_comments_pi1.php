 ...
 *
 *
 *   70: class tx_toctoccomments_pi1 extends tslib_pibase
 *  109:     function main($content, $conf)
 *  654:     protected function checkJSLoc()
 *  691:     protected function checkCSSLoc()
 *  750:     function init()
 *  822:     function mergeConfiguration()
 *  932:     function fetchConfigValue($param)
 *  955:     function createLinks($text)
 *  974:     function applyStdWrap($text, $stdWrapName)
 *
 * TOTAL FUNCTIONS: 8
