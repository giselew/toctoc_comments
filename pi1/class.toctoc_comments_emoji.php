 ...
 *   55:     protected function emojiinit ()
 *  941:     public function emoji_unified_to_html($text)
 *  952:     public function emoji_html_to_unified($text)
 *  962:     public function emoji_arr()
 *  997:     protected function emoji_convert($text, $map)
 * 1008:     protected function  emoji_get_name($unified_cp)
 *
 * TOTAL FUNCTIONS: 6
...
{
	var $emoijarr = array();
	protected function emojiinit () {
	$this->emoijarr['emoji_maps'] = array(
		'names' => array(
	...
	/**
	 * converts html (with the '<span>'s) to unified
	 *
	 * @param	string		$text: ...
	 * @return	string		...
	 */
...
// 		exit;
	 ...
	 * [Describe function...]
	 *
	 * @param	[type]		$unified_cp: ...
	 * @return	[type]		...
	 */
	protected function  emoji_get_name($unified_cp){

		return $this->emoijarr['emoji_maps']['names'][$unified_cp] ? $this->emoijarr['emoji_maps']['names'][$unified_cp] : '?';
	}
}
?>