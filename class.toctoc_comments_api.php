 ...
 *
 *
 *   63: class toctoc_comments_api
 *  104:     public function __construct()
 *  155:     public function getwebpagepreview($cmd, $cid, $data,$previewid, $conf)
 *  168:     public function handleCommentatorNotifications($ref, $conf = null, $notfromeID =false,$pid)
 *  184:     public function handleeID($ref, $conf, $messagetodisplay,$returnurl)
 *  202:     public function getAjaxRatingDisplay($ref, $conf = null, $fromAjax = false, $pid=0, $returnasarray = false, $feuserid = 0, $cmd,$cid)
 *  216:     public function getUserCard($basedimgstr,$basedtoctocuid,$conf,$commentid)
 *  234:     public function getAjaxCommentDisplay($ref, $conf = null, $fromAjax, $pid=0, $returnasarray = false,
				$feuserid = 0, $cmd, $piVars, $cid, $datathis, $AjaxData, $userpic,$commentspics, $check='',$extref='',$tctreestate  = null)
 *  266:     public function updateComment($conf,$ctid,$content,$pid)
 *  277:     public function isVoted($ref,$conf)
 *
 * TOTAL FUNCTIONS: 9
