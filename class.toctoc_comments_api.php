 ...
 *
 *
 *   59: class toctoc_comments_api
 *  102:     public function __construct()
 *  155:     public function getAjaxRatingDisplay($ref, $conf = null, $fromAjax = false, $pid=0, $returnasarray = false, $feuserid = 0, $cmd,$cid)
 *  169:     public function getUserCard($basedimgstr,$basedtoctocuid,$conf,$commentid)
 *  185:     public function getAjaxCommentDisplay($ref, $conf = null, $fromAjax, $pid=0, $returnasarray = false,
				$feuserid = 0, $cmd, $piVars, $cid, $datathis, $AjaxData, $userpic,$commentspics, $check='')
 *  216:     public function isVoted($ref,$conf,$pObj)
 *
 * TOTAL FUNCTIONS: 5
 ...
 */
		public function getAjaxCommentDisplay($ref, $conf = null, $fromAjax, $pid=0, $returnasarray = false,
			...
			$html .= $this->lib->maincomments($ref, $conf, $fromAjax, $pid, $feuserid, $cmd, $this, $piVars, $cid,$datathis['sessionCaptchaData'], $userpic,$commentspics,$check,$AjaxData);
			return $html;
		}
		/**
