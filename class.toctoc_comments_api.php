 ...
 *  302:     public function updateComment($conf, $ctid, $content, $pid, $plugincacheid)
 *  314:     public function previewcomment($data, $conf)
 *  328:     public function isVoted($ref, $scopeid, $feuser)
 *  338:     public function initCaches()
 *  349:     public function enableFields($table)
 *  360:     public function setPluginCacheControlTstamp ($external_ref_uid_list)
 *
 * TOTAL FUNCTIONS: 15
...
class toctoc_comments_api {
	...
	public function getwebpagepreview($cmd, $cid, $data, $conf) {
	 	$html = $this->lib->getwebpagepreview($cmd, $cid, $data, $this, $conf);
	 	return $html;
	}
	...
	public function previewcomment($data, $conf) {
		$retstr = $this->lib->previewcomment($data, $conf);
		return $retstr;
	}
