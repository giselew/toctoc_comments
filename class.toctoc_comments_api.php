 ...
 *
 *
 *   69: class toctoc_comments_api
 *  104:     public function __construct()
 *  124:     public function comments_getComments_fe_user($params, $conf)
 *  141:     public function getwebpagepreview($cmd, $cid, $data,$previewid, $conf)
 *  156:     public function cleanupfup($cmd, $cid, $data,$previewid, $conf,$originalfilename)
 *  169:     public function handleCommentatorNotifications($ref, $conf = null, $notfromeID =false,$pid)
 *  185:     public function handleeID($ref, $conf, $messagetodisplay,$returnurl)
 *  206:     public function getAjaxRatingDisplay($ref, $conf = null, $fromAjax = false, $pid=0, $returnasarray = false, $feuserid = 0, $cmd,$cid, $fromcomments=false, $commentspics,$scopeid=0)
 *  221:     public function getUserCard($basedimgstr,$basedtoctocuid,$conf,$commentid)
 *  239:     public function getAjaxCommentDisplay($ref, $conf = null, $fromAjax, $pid=0, $returnasarray = false,
				$feuserid = 0, $cmd, $piVars, $cid, $datathis, $AjaxData, $userpic,$commentspics, $check='',$extref='',$tctreestate  = null,$commentreplyid=0 )
 *  275:     public function updateComment($conf,$ctid,$content,$pid,$plugincacheid)
 *  285:     public function previewcomment($data,$conf)
 *  297:     public function isVoted($ref,$conf,$scopeid,$feuser)
 *  305:     public function initCaches()
 *  314:     public function enableFields($table)
 *  323:     public function setPluginCacheControlTstamp ($external_ref_uid_list)
 *
 * TOTAL FUNCTIONS: 15
 ...
 */
		public function getAjaxCommentDisplay($ref, $conf = null, $fromAjax, $pid=0, $returnasarray = false,
			...
			$html .= $this->lib->maincomments($ref, $conf, $fromAjax, $pid, $feuserid, $cmd, $this, $piVars, $cid,$datathis['sessionCaptchaData'], $userpic,$commentspics,$check,$AjaxData,$extref,$tctreestate,$commentreplyid);
			return $html;
		}
	/**
	 * updates a comment
