 ...
 *
 *
 *   65: class toctoc_comments_api
 *  106:     public function __construct()
 *  152:     public function comments_getComments_fe_user($params, $conf)
 *  169:     public function getwebpagepreview($cmd, $cid, $data,$previewid, $conf)
 *  184:     public function cleanupfup($cmd, $cid, $data,$previewid, $conf,$originalfilename)
 *  197:     public function handleCommentatorNotifications($ref, $conf = null, $notfromeID =false,$pid)
 *  213:     public function handleeID($ref, $conf, $messagetodisplay,$returnurl)
 *  233:     public function getAjaxRatingDisplay($ref, $conf = null, $fromAjax = false, $pid=0, $returnasarray = false, $feuserid = 0, $cmd,$cid, $fromcomments=false, $commentspics)
 *  248:     public function getUserCard($basedimgstr,$basedtoctocuid,$conf,$commentid)
 *  266:     public function getAjaxCommentDisplay($ref, $conf = null, $fromAjax, $pid=0, $returnasarray = false,
				$feuserid = 0, $cmd, $piVars, $cid, $datathis, $AjaxData, $userpic,$commentspics, $check='',$extref='',$tctreestate  = null)
 *  305:     public function updateComment($conf,$ctid,$content,$pid)
 *  316:     public function isVoted($ref,$conf)
 *
 * TOTAL FUNCTIONS: 11
