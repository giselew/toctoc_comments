 ...
 *
 *
 *   68: class toctoc_comments_api
 *  109:     public function __construct()
 *  155:     public function comments_getComments_fe_user($params, $conf)
 *  172:     public function getwebpagepreview($cmd, $cid, $data,$previewid, $conf)
 *  187:     public function cleanupfup($cmd, $cid, $data,$previewid, $conf,$originalfilename)
 *  200:     public function handleCommentatorNotifications($ref, $conf = null, $notfromeID =false,$pid)
 *  216:     public function handleeID($ref, $conf, $messagetodisplay,$returnurl)
 *  236:     public function getAjaxRatingDisplay($ref, $conf = null, $fromAjax = false, $pid=0, $returnasarray = false, $feuserid = 0, $cmd,$cid, $fromcomments=false, $commentspics)
 *  251:     public function getUserCard($basedimgstr,$basedtoctocuid,$conf,$commentid)
 *  269:     public function getAjaxCommentDisplay($ref, $conf = null, $fromAjax, $pid=0, $returnasarray = false,
				$feuserid = 0, $cmd, $piVars, $cid, $datathis, $AjaxData, $userpic,$commentspics, $check='',$extref='',$tctreestate  = null,$commentreplyid=0 )
 *  308:     public function updateComment($conf,$ctid,$content,$pid)
 *  318:     public function previewcomment($data,$conf)
 *  330:     public function isVoted($ref,$conf)
 *  338:     public function initCaches()
 *  347:     public function enableFields($table)
 *
 * TOTAL FUNCTIONS: 14
...
class toctoc_comments_api {
	...
	var $pi_checkCHash = false;				// Required for proper caching! See in the typo3/sysext/cms/tslib/class.tslib_pibase.php
