 ...
 *  205:     public function getAjaxRatingDisplay($ref, $conf = null, $fromAjax = false, $pid=0, $returnasarray = false, $feuserid = 0, $cmd,$cid, $fromcomments=false, $commentspics)
 *  220:     public function getUserCard($basedimgstr,$basedtoctocuid,$conf,$commentid)
 *  238:     public function getAjaxCommentDisplay($ref, $conf = null, $fromAjax, $pid=0, $returnasarray = false,
				$feuserid = 0, $cmd, $piVars, $cid, $datathis, $AjaxData, $userpic,$commentspics, $check='',$extref='',$tctreestate  = null,$commentreplyid=0 )
 *  274:     public function updateComment($conf,$ctid,$content,$pid,$plugincacheid)
 *  284:     public function previewcomment($data,$conf)
 *  295:     public function isVoted($ref,$conf)
 *  303:     public function initCaches()
 *  312:     public function enableFields($table)
 *  321:     public function setPluginCacheControlTstamp ($external_ref_uid_list)
 *
 * TOTAL FUNCTIONS: 15
