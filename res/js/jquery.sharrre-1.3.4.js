...
================================================== */
  ...
  defaults = {
    ...
    text: document.title,
    urlCurl: location.protocol + '//' + location.host + utf8_decode(tcb64_dec(configbaseURL)) +'typo3conf/ext/toctoc_comments/res/js/sharrre.php',  //PHP script for google plus...
