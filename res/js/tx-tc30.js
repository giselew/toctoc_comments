...
function toctoc_comments_uc_close(commentid){
	setopacity('tx-tc-cts-uc-' + commentid,0);
...
function show_uc(commentid, cid, commentsAjaxData,toctocuid,imgstr,timeoutms) {    
    ...
    setopacity('tx-tc-cts-uc-' + commentid,'0.9');
	        ...
	        success: function(html){
	            ...
	            if (parentid != 0) {
	                ...
	                jQuery.ajax({
	                    ...
	                    url: 'index.php?eID=toctoc_comments_ajax',
	                    async: false,
	                    data: 'ref=' + refshow + '&rating=' + rating + '&data=' + ajaxData + '&datac=' + datac + '&datathis=' + thisdata + '&capsess=0&check=' + check + '&cmd=showcomments'  + '&userpic=' + picressshow + '&commentsimgs=' + commentsImgs + '&tctreestateenc=' + tctreestateenc + '&softcheck=1' + '&extref='  + extid,
	                    success: function(html){
        ...
        if (responsed==1) {
            ...
            if(htmlretcode != 0)    {
                ...
                jQuery.ajax({
                    ...
                    url: 'index.php?eID=toctoc_comments_ajax',
                    async: false,
                    data: 'ref=' + id + '&rating=' + rating + '&data=' + ajaxData + '&datac=' + datac + '&datathis=' + thisdata + '&capsess=' + capsess + '&check=' + check + '&cmd=showcomments'  + '&userpic=' + picressshow + '&commentsimgs=' + commentsImgs + '&tctreestateenc=' + tctreestateenc + '&extref='  + extid,
                    success: function(html){
...
function savect(id, icid,pid){
	var str1=this.toctoc_comments_pi1_serialize(document.getElementById('toctoc_comments_pi1_contenttextboxc_' + id).value);
