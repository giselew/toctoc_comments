 ...
 */
class FacebookApiExceptiontc extends Exception
{
  /**
...
abstract class BaseFacebooktc
{
  ...
  public function setExtendedAccessToken() {
    ...
    catch (FacebookApiExceptiontc $e) {
  ...
  protected function makeRequest($url, $params, $ch=NULL) {
    ...
    if ($result === FALSE) {
      $e = new FacebookApiExceptiontc(array(
  ...
  protected function throwAPIException($result) {
    $e = new FacebookApiExceptiontc($result);
    switch ($e->getType()) {
      // OAuth 2.0 Draft 00 style
      case 'OAuthException':
        // OAuth 2.0 Draft 10 style
