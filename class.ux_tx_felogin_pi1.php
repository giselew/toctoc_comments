 ...
 *
 *
 *   59: class ux_tx_felogin_pi1 extends tx_felogin_pi1
 *   66:     protected function processRedirect()
...
/**
 * XCLASS around fe_login implementing AJAX login/Logout
 *
 */
class ux_tx_felogin_pi1 extends tx_felogin_pi1 {
	...
	public function main($content, $conf){
		$GLOBALS['TSFE']->additionalHeaderData[$this->prefixId]='<script src="'.
			$GLOBALS['TSFE']->tmpl->getFileName('EXT:toctoc_comments/res/js/tx-tc-ajaxfelogin.js').'" type="text/javascript"></script>';
		...
		if ($conf['toctoc_comments.']['fancybox.']['pageidnewaccount']=='') {
			...
			if (intval($conf['toctoc_comments.']['useIFrameforSignUp'])==0) {
				if (intval($conf['toctoc_comments.']['fancybox.']['pageidnewaccount'])!=0) {
					...
					'\',\'hideOnContentClick\' : false,\'speedIn\' : \'300\',\'speedOut\' : \'300\',\'changeSpeed\': \'300\',\'easingIn\': '.
					'\'swing\',\'easingOut\': \'swing\',\'transitionIn\' : \'elastic\',\'transitionOut\' : \'elastic\',\'type\' : '.
					'\'iframe\',\'autoDimensions\' : false,\'width\' : '.
				...
				$newuser='';
				$newiframe='<div class="tx-tc-login-form-iframe" id="tx-tc-iframesignup" style="display:none;">'.
						'<iframe id="tx-tc-signupiframef" frameborder="0" class="tx-tc-signupiframe" scrolling="no" src="'.
			...
			if (intval($conf['toctoc_comments.']['useIFrameforSignUp'])==0) {
				if (intval($conf['toctoc_comments.']['fancybox.']['pageidforgotpw']) != 0) {
					...
					$hrefforgotpw = str_replace('<a ',
							...
							$conf['toctoc_comments.']['fancybox.']['overlayColor'].
							'\',\'overlayOpacity\' : \''.$conf['toctoc_comments.']['fancybox.']['overlayOpacity'].
							'\',\'hideOnContentClick\' : false,\'speedIn\' : \'300\',\'speedOut\' : \'300\',\'changeSpeed\': \'300\','.
							'\'easingIn\': \'swing\',\'easingOut\': \'swing\',\'transitionIn\' : \'elastic\',\'transitionOut\' : '.
							'\'elastic\',\'type\' : \'iframe\',\'autoDimensions\' : false,\'width\' : '.
				...
				$iframeforgotpw='<div class="tx-tc-login-form-iframe-forgotpw" id="tx-tc-iframeforgotpw" style="display:none;"><iframe frameborder="0" '.
						'class="tx-tc-signupiframe" scrolling="no" src="'.
				...
				if (intval($conf['toctoc_comments.']['iframe.']['pageidforgotpw']) !=0 ) {
					$hrefforgotpw = '<a  rel="nofollow" href="javascript:void(0)" style="display:block;" id="tx-tc-linkforgotpw" '.
					'onclick="jQuery(\'#tx-tc-iframesignup\').css(\'display\', \'none\');
				...
				if (intval($conf['toctoc_comments.']['iframe.']['pageidnewaccount']) !=0 ) {
				 	$hrefnewaccount = '<a  rel="nofollow" href="javascript:void(0)" style="display:none" id="tx-tc-linkfornewaccount" ' .
