 ...
 *
 *
 *   74: class toctoc_comments_ajax
 *  106:     public function __construct()
 *  321:     public function main()
 *  346:     protected function updateComment()
 *  364:     function getCaptcha($captchatype, $cid)
 *  493:     function chkcaptcha($cid, $code)
 *  514:     protected function getUserCard()
 *  526:     protected function updateRating()
 *  725:     protected function processDeleteSubmission()
 *  758:     protected function processDenotifycommentSubmission()
 *
 * TOTAL FUNCTIONS: 9
...
class toctoc_comments_ajax {
	...
	protected function updateComment() {
		...
		$piVars = $this->piVars;
		echo $apiObj->getAjaxCommentDisplay($this->ref, $this->conf, true, $this->pid, false, $this->feuser, $this->cmd, $this->piVars, $this->cid, $this->datathis, $this->AjaxData, $this->userpic, $this->commentspics, $this->check, $this->extref);
	}
