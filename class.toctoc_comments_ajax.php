 ...
 *
 *
 *   77: class toctoc_comments_ajax
 *  116:     public function __construct()
 *  384:     public function main()
 *  416:     public function handleCommentatorNotifications()
 *  427:     protected function updateCommentDisplay()
 *  442:     protected function updateComment()
 *  457:     protected function webpagepreview()
 *  471:     function getCaptcha($captchatype, $cid)
 *  601:     function chkcaptcha($cid, $code)
 *  622:     protected function getUserCard()
 *  634:     protected function updateRating()
 *  833:     protected function processDeleteSubmission()
 *  878:     protected function processDenotifycommentSubmission()
 *
 * TOTAL FUNCTIONS: 12
...
class toctoc_comments_ajax {
	...
	public function __construct() {
		...
		if($this->cmd == 'getcap') {
			...
			$this->content=  base64_decode($content_str);
 ...
 */
	...
	protected function processDeleteSubmission() {
		...
		// Clear cache
		/* $cacheidlist = strval($this->pid); // . ', 100';
		$pi dList = t3lib_div::intExplode(',', $cacheidlist);*/
