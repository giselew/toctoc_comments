 ...
 *   66:     function extraItemMarkerProcessor($markerArray, $row, $lConf, &$pObj)
 *  210:     function getNumberOfComments($newsUid, &$pObj)
 *  229:     function getTemplate($section, $conf, &$pObj)
 *  259:     function getItemLink($marker, $itemUid, &$pObj)
 *
 * TOTAL FUNCTIONS: 4
