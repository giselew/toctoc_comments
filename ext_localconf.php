...
if (version_compare(TYPO3_version, '4.99', '>')) {
	...
	$GLOBALS['TYPO3_CONF_VARS']['FE']['XCLASS']['ext/felogin/pi1/class.tx_felogin_pi1.php'] = t3lib_extMgm::extPath($_EXTKEY).'class.ux_tx_felogin_pi1.php';
}
