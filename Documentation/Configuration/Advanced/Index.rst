...
dateFormatMode                                                                  string      Determines what PHP function to use for date             strftime
                                                                                            formatting. Defaults to â€œdateâ€?. If you want to use   (Changed in V 7.2.0)
...
commentReview                                                                   boolean     Commenting works in Review                               0
                                                                                            ...
                                                                                            Please read chapter â€œReviewsâ€? for
                                                                                            more information on this

                                                                                            (P â€“ General,
                                                                                            Advanced â€“ Comments are reviews:)
...
autoConvertLinks                                                                boolean     If enabled, will search for possible links in comment    1
                                                                                            ...
                                                                                            Links are always created with `rel=â€?nofollowâ€?
                                                                                            <http://googleblog.blogspot.com/2005/01/
                                                                                            preventing-comment-spam.html>`__
                                                                                            and css class â€œtx-comments-external-autolinkâ€?.
...
You find them now in section â€œsharingâ€?.
...
recentcommentsPluginpages                                                       string      Pages with a record to display :
                                                                                            ...
                                                                                            prefix = â€œAllâ€?) and report bad comments forms.
...
------------------------------------------------------------------------------  ----------  -------------------------------------------------------  -----------------------------------------------------
displayChildComments                                                            boolean     Display the link for and number of subcomments â€“ in      1
                                                                                            addition to the â€œexpand-collapseâ€?-Icons (if
                                                                                            useUserPic=1)
------------------------------------------------------------------------------  ----------  -------------------------------------------------------  -----------------------------------------------------
