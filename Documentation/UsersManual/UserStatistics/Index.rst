...
.. _users-manual-user-statistics:

User Statistics
---------------

**User Statistics**  which are maintained by the plugin help to see user activities, and allows to
keep track.
...
So the
format for anonymous users is 'IP.0' (example: 184.126.45.22.0)


.. figure:: /Images/image-54.jpg
