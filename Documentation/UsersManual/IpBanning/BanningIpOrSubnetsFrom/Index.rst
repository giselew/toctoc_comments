...
.. _users-manual-ip-banning-banning-ip-or-subnets-from:

Banning IP or subnets from access to the website
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

In the Extension Configuration Options you will find option 
